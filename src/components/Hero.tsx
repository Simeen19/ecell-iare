    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 hero-bg">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-10 left-0 w-full h-2 bg-gradient-wave animate-wave opacity-20" style={{ animationDelay: '1s' }}></div>
          <div className="absolute top-20 left-0 w-full h-2 bg-gradient-wave animate-wave opacity-10" style={{ animationDelay: '2s' }}></div>
        </div>
      </div>
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        <div className="animate-fade-in-up">
          ...
          <p className="text-lg md:text-xl text-pure-white/80 mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{ animationDelay: '0.9s' }}>
            <Button
              size="lg"
              className="bg-deep-green hover:bg-soft-teal text-pure-white px-8 py-4 text-lg font-semibold rounded-full smooth-hover hover:scale-105 shadow-hover"
            >
              Join Our Community
            </Button>
            <Button
        ...
        <div className="absolute bottom-20 left-20 w-8 h-8 bg-pale-aqua rounded-full animate-float opacity-40" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-40 right-10 w-5 h-5 bg-light-mint rounded-full animate-pulse-soft opacity-50" style={{ animationDelay: '1s' }}></div>
      </div>
